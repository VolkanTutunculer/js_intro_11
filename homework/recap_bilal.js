...
const getMultipleOf5Redo = (num1, num2) => { 
...
console.log(getMultipleOf5Redo(3, 17))
console.log(getMultipleOf5Redo(23, 5))
console.log(getMultipleOf5Redo(5, 5))
console.log(getMultipleOf5Redo(2, 4))
